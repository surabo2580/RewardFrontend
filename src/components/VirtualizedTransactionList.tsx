  ...
  return (
    <div className="border border-slate-800 rounded-lg overflow-hidden">
      <List
        ...
        rowProps={{ items: transactions, onSelect: onSelectTransaction }}
        rowComponent={({ index, style, items, onSelect }: any) => {
          ...
          return (
            <div
              ...
              className="flex items-center px-4 py-2 border-b border-slate-800 hover:bg-slate-800/50 transition-colors text-sm cursor-pointer"
            >
